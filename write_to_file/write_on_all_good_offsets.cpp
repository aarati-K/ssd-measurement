...
* Overwrites the whole file essentially, for the 64KB chunk size.
*/
...
int main() {
    ...
    fd = open("/home/aarati/workspace/CS736/ssd-measurements/test_files/test_1mb_seq", O_RDWR | O_DIRECT | O_SYNC);
